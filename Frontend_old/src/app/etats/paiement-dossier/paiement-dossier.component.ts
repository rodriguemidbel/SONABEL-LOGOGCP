...
@Component({
  selector: 'app-paiement-dossier',
  templateUrl: './paiement-dossier.component.html',
  styleUrls: ['./paiement-dossier.component.css']
})
export class PaiementDossierComponent implements OnInit {
