...
@Component({
  selector: 'app-dossierinfructueux',
  templateUrl: './dossierinfructueux.component.html',
  styleUrls: ['./dossierinfructueux.component.css']
})
export class DossierinfructueuxComponent implements OnInit {
  base_url:string;
