...
@Component({
  selector: 'app-vente-dossier-procedure',
  templateUrl: './vente-dossier-procedure.component.html',
  styleUrls: ['./vente-dossier-procedure.component.css']
})
export class VenteDossierProcedureComponent implements OnInit {
