...
import { Localisation } from 'src/app/models/localisation.model';
...
@Component({
  selector: 'app-suivitdossier',
  templateUrl: './suivitdossier.component.html',
  styleUrls: ['./suivitdossier.component.css']
})
export class SuivitdossierComponent implements OnInit {
