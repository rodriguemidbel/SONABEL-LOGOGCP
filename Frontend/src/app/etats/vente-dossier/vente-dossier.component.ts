...
@Component({
  selector: 'app-vente-dossier',
  templateUrl: './vente-dossier.component.html',
  styleUrls: ['./vente-dossier.component.css']
})
export class VenteDossierComponent implements OnInit {
