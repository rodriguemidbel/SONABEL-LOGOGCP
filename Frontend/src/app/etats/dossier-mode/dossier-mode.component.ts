...
@Component({
  selector: 'app-dossier-mode',
  templateUrl: './dossier-mode.component.html',
  styleUrls: ['./dossier-mode.component.css']
})
export class DossierModeComponent implements OnInit {
  ...
  dossierByMode(){
    this.httpclient.get<any>(this.base_url+'/dossierByMode/2022').subscribe(
      response => {
