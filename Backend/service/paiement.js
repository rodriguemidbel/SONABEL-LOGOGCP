...
class paiementService {
  createPaiement(PaiementDto) {
    const { marche_id,num_facture,date_facture,montant_cfa,montant_devise,devise,
      taux_exe_phy,taux_exe_fin,observation,fichier } = PaiementDto;
    return paiementDAO.createPaiement(marche_id,num_facture,date_facture,
      montant_cfa,montant_devise,devise,taux_exe_phy,taux_exe_fin,observation,fichier);
  };
  getAllPaiement() {
